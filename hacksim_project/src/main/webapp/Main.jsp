                            ...
                            <div class="col-xl-3 col-md-6">
                                <div class="card bg-primary text-black2 mb-4" style="background-color: whitesmoke !important;">
                                    ...
                                    <div class="card-footer d-flex align-items-center justify-content-between" style="height: 80px;">
                                        ...
                                        <a href="Main.jsp"><button id="cctv_click" style="transition: all 0.3s ease; border: 3px solid #A9A9A9; border-radius: 5px;" onmouseover="this.style.boxShadow='-7px -7px 20px 0px #fff9,-4px -4px 5px 0px #fff9,7px 7px 20px 0px #0002,4px 4px 5px 0px #0001'" onmouseout="this.style.boxShadow='none'">초기화</button></a>
