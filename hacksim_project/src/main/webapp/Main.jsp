...
<script type="text/javascript"
	src="https://sgisapi.kostat.go.kr/OpenAPI3/auth/javascriptAuth?consumer_key=bd2d0b75d234444f8b15"></script>
			...
			<li class="nav-item dropdown"><a
				...
				<ul class="dropdown-menu dropdown-menu-end"
					...
					<li><a class="dropdown-item"
						href="DeleteMemSer?id=<%= LoginMember.getId() %>">회원탈퇴</a></li>
					...
					<div class="row">
						<div class="col-xl-3 col-md-6">
							<div class="card bg-primary text-black2 mb-4">
								...
								<div
									...
									<input id="text-balck" type="checkbox" name="service"
										value="center"> 치안센터 <input id="text-balck"
										type="checkbox" name="service" value="ccte"> CCTV <input
										id="text-balck" type="checkbox" name="service" value="bell">
									비상벨
						...
						<div class="col-xl-3 col-md-6">
							<div class="card bg-warning text-white mb-4">
								...
								<div
									class="card-footer d-flex align-items-center justify-content-between">
									위치 <select name="location">
										<hr>
										<option value="seoul">서울시</option>
									</select> <select name="location2">
										<hr>
						...
						<div class="col-xl-6">
							<div class="card mb-4">
								<div class="card-header">
									<i class="fas fa-chart-area me-1"></i> 서울시 전체 지도
								</div>
								<div class="card-body" id="map"
									style="width: 890px; height: 700px;"></div>
							</div>
						</div>
						<div class="col-xl-6">
							<div class="card mb-4">
								<div class="card-header">
									<i class="fas fa-chart-bar me-1"></i> 전체 범죄율 변화
								</div>
								<div class="card-body">
